...
export default function CampgroundLocation() {
  ...
  const locations = allLocations?.filter((loc: any) => 
    loc.category?.toLowerCase().includes("camp") || 
    loc.type?.toLowerCase().includes("camp")
  );
    ...
    <div className="bg-zinc-950 rounded-lg overflow-hidden border border-[#12271F] px-6">
      ...
      {locations?.map((location: any) => (
        ...
        >
          ...
          {/* Type */}
          <TypeButton type={location.category || "Campground"} bg="bg-[#3B0764]" />
